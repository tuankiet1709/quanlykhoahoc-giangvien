...
const ClassTable = ({
  ...
  const handleShowInfo = (id) => {
    const class1 = classes.find((item) => item.id === id);
    console.log("handle show",class1);

    if (class1) {
      console.log("class in if", class1);
      setClassDetail(class1);
      setShowDetail(true);
    }
  };
  ...
  return (
    <>
      ...
      {classDetail && showDetail && (
        <Info class1={classDetail} handleClose={handleCloseDetail} />
      )}
      <ConfirmModal
