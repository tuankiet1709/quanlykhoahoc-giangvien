      ...
      >
        ...
        <div className="container-fluid">
            ...
            <div className="row -intro-y mt-2">
              ...
              <div className="col-8 text-wrap text-break">
                {schedule?room.name:"Chưa có phòng học"}
              </div>
            </div>
            ...
            <div className="row -intro-y mt-2">
              ...
              <div className="col-8 text-wrap text-break">
                {schedule?"Thứ "+schedule.DoW + " "+ shift.startHour:"Chưa có lịch học"}
              </div>
            </div>
            ...
            <div className="row -intro-y mt-2">
              ...
              <div className="col-8 text-wrap text-break">
                {teacher?teacher.firstName + " " + teacher.lastName:"Chưa có giảng viên"}
                </div>
            </div>
